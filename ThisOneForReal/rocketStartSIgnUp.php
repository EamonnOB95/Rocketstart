...
<div class="container">
        ...
        <p>Already a user? <a href="rocketStartSignIn.php">Sign In</a></p>
 <!--                    <form>
                        <label for="name">Name:</label>
                        <br>
                        <input type = "text" id="name" name="name" placeholder="Michael D. Higgins">
                        <br>
                        <label for="email">Email Address:</label>
                        <br>
                        <input type = "text" id="email" name="email" placeholder="miggeldy@gmail.com">
                        <br>
